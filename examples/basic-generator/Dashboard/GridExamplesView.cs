...
public sealed class GridExamplesView : Element
{
    public GridExamplesView() : base("div")
    {
        this.Padding("2rem")
            .BackgroundColor("#f3f4f6")
            .Content(
                // Title
                H1().Text("CSS Grid Examples")
                    .TextColor("#111827")
                    .MarginBottom("2rem"),
                ...
                new Div()
                    .Content(
                        H2().Text("Simple Grid - 3 Columns").MarginBottom("1rem"),
                        new Div()
                            .Grid()
                            .GridCols(3)
                            .Gap("1rem")
                ...
                new Div()
                    .Content(
                        H2().Text("Column Spanning").MarginBottom("1rem"),
                        new Div()
                            .Grid()
                            .GridCols(4)
                            .Gap("1rem")
                ...
                new Div()
                    .Content(
                        H2().Text("Custom Grid Template").MarginBottom("1rem"),
                        new Div()
                            .Grid()
                ...
                new Div()
                    .Content(
                        H2().Text("Dashboard Layout").MarginBottom("1rem"),
                        new Div()
                            .Grid()
                            .GridCols(4)
                            .GridRows(3)
                ...
                new Div()
                    .Content(
                        H2().Text("Alignment Examples").MarginBottom("1rem"),
                        new Div()
                            .Grid()
                            .GridCols(3)
                            .Gap("1rem")
